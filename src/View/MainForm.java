...
public class MainForm extends JFrame {
    ...
    public MainForm() {
        ...
        sinhVienPanel.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));

        bangDiemPanel = new JPanel();
        bangDiemPanel.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
        ...
        lopHocPanel.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
        ...
        monHocPanel.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
        ...
        khoaPanel.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
        ...
        thongTinPanel.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
